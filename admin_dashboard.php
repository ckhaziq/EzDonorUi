...
//users
//TotalUser
$resultTotalUser = mysqli_query($con, "SELECT COUNT(*) AS TotalUser FROM user WHERE UserAccountType != 1");
$num_rowsTotalUser = mysqli_fetch_assoc($resultTotalUser);
//Donee
$resultDonee = mysqli_query($con, "SELECT COUNT(*) AS TotalDonee FROM user WHERE UserAccountType = 3");
$num_rowsDonee = mysqli_fetch_assoc($resultDonee);
//Donor
$resultDonor = mysqli_query($con, "SELECT COUNT(*) AS TotalDonor FROM user WHERE UserAccountType = 2");
$num_rowsDonor = mysqli_fetch_assoc($resultDonor);
//Dapur
$resultDapur = mysqli_query($con, "SELECT COUNT(*) AS TotalDapur FROM user WHERE UserAccountType = 4");
$num_rowsDapur = mysqli_fetch_assoc($resultDapur);

$TotalUser100 = $num_rowsTotalUser['TotalUser'];
$TotalDonee100 = $num_rowsDonee['TotalDonee'] / $num_rowsTotalUser['TotalUser'] * 100;
$TotalDonor100 = $num_rowsDonor['TotalDonor'] / $num_rowsTotalUser['TotalUser'] * 100;
$TotalDapur100 = $num_rowsDapur['TotalDapur'] / $num_rowsTotalUser['TotalUser'] * 100;

$dataPointsUser = array(
    array("label" => "Donee", "y" => $TotalDonee100),
    array("label" => "Donor", "y" => $TotalDonor100),
    array("label" => "Dapur", "y" => $TotalDapur100)
)
?>
...
<script>
    window.onload = function() {
        ...
        var chart2 = new CanvasJS.Chart("chartContainer2", {
            animationEnabled: true,
            title: {
                text: "The number of user of EZDonor"
            },
            subtitles: [{
                text: ""
            }],
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget navy-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                ...
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsTotalRequest['TotalTotalRequest']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget navy-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                <span>Approved</span>
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsApproved['TotalApproved']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget navy-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                ...
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsWaitingApproval['TotalWaitingApproval']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget navy-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                ...
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsRejected['TotalRejected']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget lazur-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                ...
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsTotalUser['TotalUser']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="span3">
                                    <div style="border-radius: 10px; margin: 10px;" class="widget yellow-bg">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                <span>Total Donee</span>
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsDonee['TotalDonee']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-radius: 10px; margin: 10px;" class="widget bg-danger">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                ...
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsDonor['TotalDonor']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="span3">
                                    <div style="border-radius: 10px; margin: 10px;" class="widget bg-danger">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span8 text-right">
                                                <span>Total Dapur</span>
                                                <h2 class="font-bold">
                                                    <?php echo $num_rowsDapur['TotalDapur']; ?>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
