                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $ApprovalID = $RequestID = $rowView["ApprovalID"];
                                            if ($ApprovalID == 0) {
                                                echo "Waiting Approval";
                                            } else {
                                                $RequestID = $rowView["RequestID"];

                                                $sqlStatus = "SELECT * FROM approval WHERE RequestID = '$RequestID'";
                                                $resultStatus = mysqli_query($con, $sqlStatus);
                                                $rowResult = mysqli_fetch_assoc($resultStatus);

                                                echo $rowResult["ApprovalStatus"];
                                            }
