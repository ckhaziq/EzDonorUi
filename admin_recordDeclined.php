                ...
                <div style="margin: auto;  width: 50%;  padding: 10px;">
                    <table>
                        ...
                        <tbody>
                            ...
                            $sqlRequestID = "SELECT * FROM approval WHERE ApprovalStatus = 'Decline'";

                            $resultRequestID = $con->query($sqlRequestID);

                            if ($resultRequestID->num_rows > 0) {
                                while ($rowRequestID = $resultRequestID->fetch_assoc()) {
                                    $RequestID = $rowRequestID["RequestID"];

                                    $sqlView = "SELECT * FROM request WHERE RequestID = '$RequestID'";
