                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="operation.php" method="POST">
                                        <input name="RequestID" type="text" value="<?php echo $rowView["RequestID"]; ?>"
                                            hidden>
                                        <input name="adminDecline" type="submit" value="Decline">
                                        <input name="adminApprove" type="submit" value="Approve">
                                    </form>
                                </td>
                            </tr>
                        <?php 
