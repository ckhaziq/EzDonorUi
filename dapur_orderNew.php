                    ...
                    <div style="margin: auto;  width: 70%;  padding: 10px;">
                        <table>
                            ...
                            <tbody>
                                ...
                                $sqlView = "SELECT * FROM ordertable WHERE DapurID = $DapurID AND OrderStatus='New'";
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $rowView["DonorID"]; ?></td>
                                            <td><?php echo $rowView["DoneeID"]; ?></td>
                                            ...
                                            <td>
                                                <form action="operation.php" method="POST">
                                                    ...
                                                    <input name="OrderAccept" type="submit" value="Accept">
                                                </form>
                                            </td>
                                        </tr>
                                <?php
