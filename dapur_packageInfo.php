            ...
            <div id="main">
                ...
                <div style="width: 100%; background-color: grey; margin-top: 13px;" id="main-contents">
                    <div style="margin: auto;  width: 60%;  padding: 10px;">
                        <div align="right">
                            <a href="dapur_packageInfoAdd.html"><input name="PackageAdd" type="submit" value="Add New Package"></a>
                        </div>
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                $sqlView = "SELECT * FROM package WHERE DapurID = $DapurID";
                                ...
                                ?>
                                        <tr>
                                            <td><img src="./image/<?php echo $rowView['PackageImage']; ?>"></td>
                                            <td><?php echo $rowView["PackageName"]; ?></td>
                                            <td><?php echo $rowView["PackagePrice"]; ?></td>
                                            <td><?php echo $rowView["PackageMinOrder"]; ?></td>
                                            <td>
                                                <form action="operation.php" method="POST">
                                                    <input name="PackageID" type="text" value="<?php echo $rowView["PackageID"]; ?>" hidden>
                                                    <input name="PackageDelete" type="submit" value="Delete">
                                                </form>
                                                <a href="dapur_packageInfoUpdate.php?PackageID=<?php echo $rowView["PackageID"]; ?>"><input type="submit" value="Update"></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
