                            ...
                            <div style="margin: auto;" class="container">
                                ...
                                ?>
                                    ...
                                    <div class="inputwrap col">
                                        ...
                                        <input id="name" name="PackageName" type="text"
                                            value="<?php echo $rowView["PackageName"]; ?>">
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="name" id="name-label" class="bold">Price per Serving</label>
                                        <input id="name" name="PackagePrice" type="number"
                                            value="<?php echo $rowView["PackagePrice"]; ?>">
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="email" id="email-label" class="bold">Minimun Order</label>
                                        <input id="name" name="PackageMinOrder" type="number"
                                            value="<?php echo $rowView["PackageMinOrder"]; ?>">
                                    </div>
                                    <input id="name" name="PackageID" type="number"
                                        value="<?php echo $rowView["PackageID"]; ?>">
