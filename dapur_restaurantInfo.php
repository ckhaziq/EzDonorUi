                                ...
                                <form id="survey-form" action="operation.php" method="POST">
                                    ...
                                    ?>
                                            <div class="inputwrap col">
                                                ...
                                                <input id="name" name="DapurName" type="text" value="<?php echo $rowView["DapurName"]; ?>">
                                            </div>
                                            <div class="inputwrap col">
                                                <label for="name" id="name-label" class="bold">Location</label>
                                                <input id="name" name="DapurLocation" type="text" value="<?php echo $rowView["DapurLocation"]; ?>">
                                            </div>
                                            <div class="inputwrap col">
                                                <label for="email" id="email-label" class="bold">Description</label>
                                                <input id="name" name="DapurDescription" type="text" value="<?php echo $rowView["DapurDescription"]; ?>">
                                            </div>
                                            <div class="inputwrap col">
