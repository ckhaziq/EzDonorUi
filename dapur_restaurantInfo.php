                            ...
                            <div style="margin: auto;" class="container">
                                ...
                                ?>
                                    <div class="inputwrap col">
                                        ...
                                        <input id="name" name="DapurName" type="text"
                                            value="<?php echo $rowView["DapurName"]; ?>">
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="name" id="name-label" class="bold">Location</label>
                                        <input id="name" name="DapurLocation" type="text"
                                            value="<?php echo $rowView["DapurLocation"]; ?>">
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="email" id="email-label" class="bold">Description</label>
                                        <input id="name" name="DapurDescription" type="text"
                                            value="<?php echo $rowView["DapurDescription"]; ?>">
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="email" id="email-label" class="bold">Delivery Hours</label>
                                        <input id="name" name="DapurDeliveryHours" type="text"
                                            value="<?php echo $rowView["DapurDeliveryHours"]; ?>">
                                    </div>
