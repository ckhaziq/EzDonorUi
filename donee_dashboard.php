            ...
            <nav role="navigation" class="menu">
                ...
                <div class="overflow-container">
                    ...
                    <ul class="menu-dropdown">
                        ...
                        <li><a href="donee_dashboard.php">Dashboard</a><span class="icon"><i class="fa fa-dashboard"></i></span></li>
                        ...
                        <li class="menu-hasdropdown">
                            ...
                            <ul class="sub-menu-dropdown">
                                <li><a href="donee_catalogue_package.php">Package Catalogue</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="container">
                                ...
                                <form id="survey-form" action="operation.php" method="POST">
                                    ...
                                    <div class="inputwrap col">
                                        ...
                                        <input name="RequestIC" type="text" id="name" required
                                            placeholder="Enter your MyKad Number" />
                                    </div>
                                    <div class="inputwrap col">
                                        <label for="email" id="email-label" class="bold">Phone Number</label>
                                        <input name="RequestPhone" type="text" id="name" required
